...
public interface BoardMapper {
    ...
    @Update("UPDATE board SET subject=#{subject}, writer=#{writer}, content=#{content}, regdate=now(), orgName=#{orgName},savedFileName=#{savedFileName}, " +
            "savedFilePathName = #{savedFilePathName}, savedFileSize=#{savedFileSize}, folderName=#{folderName}, ext=#{ext} WHERE id = #{id}")
